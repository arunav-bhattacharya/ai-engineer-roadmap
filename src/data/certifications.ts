...
export const CERTIFICATIONS: Certification[] = [
  {
    ...
    when: 'Spread across W2, W10, W11, W19 — modules align with the topic you are already studying that week.',
    why: 'Highest leverage cert in the list — covers transformers, tokenization, fine-tuning, datasets, and diffusers. If you actually do W10 and W11, you have done ~80% of the material already. Free, well-maintained, recognised everywhere.',
    process: [
      ...
      'During W10 — work the fine-tuning chapters end-to-end (Ch 3, 7); run them against your own dataset.',
      'During W11 — datasets + LLM course depth (Ch 5–6 + LLM course modules on alignment / RLHF basics).',
      'During W19 — the Diffusion Models Course (separate track on the same learn hub).',
  ...
  },
  {
    ...
    mapsTo: ['w2', 'w4'],
    when: 'Take after W4 (FM internals) when the theory is fresh — much of the course material is review at that point and you knock it out in two weekends.',
    why: 'Most brand-name LLM-specific cert on the list. Hands-on labs reinforce W2 (prompting, in-context learning) and W4 (scaling laws, RLHF, instruction tuning). Adds a recognisable name to your resume.',
    process: [
  ...
  },
  {
    ...
    cost: '$70.50',
    mapsTo: ['w18'],
    when: 'Sit the exam the week after W18 — Day 4 of W18 has you writing Terraform; the exam prep is essentially that work plus the docs.',
    why: 'W18 already has you Terraform-ing AWS infra. The exam is multiple choice, accessible, and universally respected by hiring managers. Best dollar-per-resume-line ratio in the list.',
    process: [
  ...
  },
  {
    ...
    cost: '$100',
    mapsTo: ['w18'],
    when: 'Right after Terraform Associate — prep overlaps with W18 (Bedrock, SageMaker, AWS AI services). One cycle, two badges.',
  ...
  },
  {
    ...
    cost: '$150',
    mapsTo: ['w10', 'w17', 'w18'],
    when: 'After the capstone ships and W20 is done — this is the heavyweight badge to chase in month 6–7, not during the build phase.',
    ...
    process: [
      ...
      'Hands-on with SageMaker, Bedrock, Step Functions — much of W18 maps directly.',

...
export const CERTIFICATIONS: Certification[] = [
  {
    ...
    effort: '~25 hours',
    cost: 'Free',
    mapsTo: ['w2', 'w6', 'w14', 'w17'],
    when: 'Spread across W2, W6, W14, W17 — modules align with the topic you are already studying that week.',
    why: 'Highest leverage cert in the list — covers transformers, tokenization, fine-tuning, datasets, and diffusers. If you actually do W6 and W14, you have done ~80% of the material already. Free, well-maintained, recognised everywhere.',
    process: [
      'Create a Hugging Face account; install <code>huggingface_hub</code> and log in via <code>huggingface-cli</code>.',
      'During W2 — finish the NLP / Transformers chapters (Ch 1–4).',
      'During W6 — work the fine-tuning chapters end-to-end (Ch 3, 7); run them against your own dataset.',
      'During W14 — datasets + LLM course depth (Ch 5–6 + LLM course modules on alignment / RLHF basics).',
      'During W17 — the Diffusion Models Course (separate track on the same learn hub).',
  ...
  },
  {
    ...
    cost: 'Free',
    mapsTo: ['w5', 'w13'],
    when: 'Finish during or right after W5 — that week already builds the same agent in LangGraph + 3 others.',
    why: 'LangGraph is the agent framework most commonly asked about in 2026 interviews. Short, focused, free, badge on completion. W5 builds in it already so net-new study is minimal.',
    process: [
  ...
  },
  {
    ...
    mapsTo: ['w2', 'w11'],
    when: 'Take after W11 (FM internals) when the theory is fresh — much of the course material is review at that point and you knock it out in two weekends.',
    why: 'Most brand-name LLM-specific cert on the list. Hands-on labs reinforce W2 (prompting, in-context learning) and W11 (scaling laws, RLHF, instruction tuning). Adds a recognisable name to your resume.',
    process: [
  ...
  },
  {
    ...
    cost: '$70.50',
    mapsTo: ['w16'],
    when: 'Sit the exam the week after W16 — Day 4 of W16 has you writing Terraform; the exam prep is essentially that work plus the docs.',
    why: 'W16 already has you Terraform-ing AWS infra. The exam is multiple choice, accessible, and universally respected by hiring managers. Best dollar-per-resume-line ratio in the list.',
    process: [
  ...
  },
  {
    ...
    cost: '$100',
    mapsTo: ['w16'],
    when: 'Right after Terraform Associate — prep overlaps with W16 (Bedrock, SageMaker, AWS AI services). One cycle, two badges.',
  ...
  },
  {
    ...
    cost: '$150',
    mapsTo: ['w6', 'w15', 'w16'],
    when: 'After the capstone ships and W18 is done — this is the heavyweight badge to chase in month 6–7, not during the build phase.',
    ...
    process: [
      ...
      'Hands-on with SageMaker, Bedrock, Step Functions — much of W16 maps directly.',
